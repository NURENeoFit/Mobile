...
final TextTheme customTextTheme = const TextTheme(
  ...
  titleLarge: TextStyle(fontSize: 22, fontWeight: FontWeight.w600), // Section/Card/Block Title //18
  bodyLarge: TextStyle(fontSize: 16), // Main text (paragraphs, signatures, details)
  bodyMedium: TextStyle(fontSize: 14, color: Colors.black87), // Secondary text (for descriptions, dates, system text)
